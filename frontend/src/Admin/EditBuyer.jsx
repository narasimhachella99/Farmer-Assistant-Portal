...
const EditBuyer = () => {
    ...
    const getData = async () => {
        const res = await axios.get(`http://localhost:8080/api/v1/buyerByEmail/${params.email}`)
    ...
    const handleSubmit = async (id) => {
        const res = await axios.patch(`http://localhost:8080/api/v1/buyer/${id}`, data)
          ...
          <div className='grid grid-cols-12 mt-5'>
                <div className='col-start-2 col-end-7 mt-5'>
                    <div className="bg-gray-100 rounded-lg p-8 bg-gradient-to-l from-sky-600  to-green-600 md:ml-auto w-auto mt-10 md:mt-0">
                        <h2 className="text-gray-900 text-lg font-medium title-font mb-5">Edit Buyer</h2>
                        <div className=' gap-3'>
                            <div className="   mb-4">
